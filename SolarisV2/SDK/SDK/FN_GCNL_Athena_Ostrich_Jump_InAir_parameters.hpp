...
struct AGCNL_Athena_Ostrich_Jump_InAir_C_OnApplication_Params
{
public:
...
struct AGCNL_Athena_Ostrich_Jump_InAir_C_ExecuteUbergraph_GCNL_Athena_Ostrich_Jump_InAir_Params
{
public:
	...
	class USkeletalMeshComponent*                CallFunc_GetMechMesh_ReturnValue;                  // 0x110(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_K2_AttachToComponent_ReturnValue;         // 0x118(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
