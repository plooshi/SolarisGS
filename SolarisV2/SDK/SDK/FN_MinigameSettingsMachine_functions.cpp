...
void AMinigameSettingsMachine_C::UpdateGameMode(class AFortMinigame* CurrentMinigame, const struct FGameplayTagContainer& CallFunc_GetUIExtensions_Return_Value, TArray<class UClass*>& CallFunc_GetScoreboardStatsArray_ScoreboardStats, bool CallFunc_Conv_IntToBool_ReturnValue, class AFortMinigame* CallFunc_GetCurrentMinigame_Minigame, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;
