...
public:
	...
	uint8                                        Pad_54CB[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FFortGameplayEffectContainerSpec      CallFunc_SetupGrenade_Explosion_Gameplay_Spec;     // 0x178(0x88)(None)
	...
	struct FFortGameplayEffectContainerSpec      CallFunc_SetupGrenade_Additional_Explosion_Gameplay_Spec; // 0x208(0x88)(None)
	...
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate_8;            // 0x40C(0x10)(ZeroConstructor, NoDestructor)
	...
	float                                        CallFunc_GetServerWorldTimeSeconds_ReturnValue;    // 0x428(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
