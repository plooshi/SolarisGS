...
public:
	...
	uint8                                        Pad_2548[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_GetShortDescription_ReturnValue;          // 0x150(0x18)(None)
	class FText                                  CallFunc_GetDisplayName_ReturnValue;               // 0x168(0x18)(None)
	...
	uint8                                        Pad_254F[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
