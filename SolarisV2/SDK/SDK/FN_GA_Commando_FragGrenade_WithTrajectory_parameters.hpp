...
public:
	...
	struct FFortGameplayEffectContainerSpec      CallFunc_MakeGameplayEffectContainerSpec_ReturnValue; // 0xB8(0x88)(None)
	struct FFortGameplayEffectContainerSpec      CallFunc_MakeGameplayEffectContainerSpec_ReturnValue_1; // 0x140(0x88)(None)
	struct FFortGameplayEffectContainerSpec      CallFunc_MakeGameplayEffectContainerSpec_ReturnValue_2; // 0x1C8(0x88)(None)
...
public:
	...
	uint8                                        Pad_4827[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FFortGameplayEffectContainerSpec      CallFunc_MakeGameplayEffectContainerSpec_ReturnValue; // 0xA8(0x88)(None)
	struct FScalableFloat                        CallFunc_EvaluatePerkTierBalanceValue_Balance_Value; // 0x130(0x20)(None)
	...
	struct FFortGameplayEffectContainer          CallFunc_BP_GetGameplayEffectContainer_ReturnValue; // 0x158(0x90)(None)
...
public:
	...
	struct FFortGameplayEffectContainerSpec      CallFunc_SetupGrenade_Explosion_Gameplay_Spec;     // 0x190(0x88)(None)
	...
	uint8                                        Pad_484F[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_SetHolsterWeaponWithName_IsWeaponHolstered; // 0x269(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_SetHolsterWeaponWithName_OperationSuccessful; // 0x26A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4851[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_SetHolsterWeaponWithName_IsWeaponHolstered_1; // 0x27B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_SetHolsterWeaponWithName_OperationSuccessful_1; // 0x27C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
