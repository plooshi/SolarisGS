...
public:
	...
	enum class EFortInventoryFilter              CallFunc_GetFilterCategory_ReturnValue;            // 0x230(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	class FText                                  Temp_text_Variable_12;                             // 0x138(0x18)(None)
	class FText                                  Temp_text_Variable_13;                             // 0x150(0x18)(None)
	class FText                                  Temp_text_Variable_14;                             // 0x168(0x18)(None)
	class FText                                  Temp_text_Variable_15;                             // 0x180(0x18)(None)
	class FText                                  Temp_text_Variable_16;                             // 0x198(0x18)(None)
	class FText                                  Temp_text_Variable_17;                             // 0x1B0(0x18)(None)
	class FText                                  Temp_text_Variable_18;                             // 0x1C8(0x18)(None)
	class FText                                  Temp_text_Variable_19;                             // 0x1E0(0x18)(None)
	bool                                         Temp_bool_Variable;                                // 0x1F8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class EFortInventoryFilter              Temp_byte_Variable;                                // 0x1F9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_6153[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_GetEmptyText_ReturnValue;                 // 0x200(0x18)(None)
	class FText                                  CallFunc_GetTertiaryCategory_ItemCategoryText;     // 0x218(0x18)(None)
	struct FSlateBrush                           CallFunc_GetTertiaryCategory_ItemCategoryBrush;    // 0x230(0x88)(None)
	bool                                         CallFunc_GetTertiaryCategory_ReturnValue;          // 0x2B8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	enum class EFortInventoryFilter              CallFunc_GetFilterCategory_ReturnValue;            // 0x318(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_6155[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_GetDisplayName_ReturnValue;               // 0x320(0x18)(None)
	bool                                         CallFunc_EqualEqual_TextText_ReturnValue;          // 0x338(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_6156[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  K2Node_Select_Default;                             // 0x340(0x18)(None)
	class FText                                  CallFunc_TextTrimPrecedingAndTrailing_ReturnValue; // 0x358(0x18)(None)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData_1;            // 0x370(0x40)(HasGetValueTypeHash)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array;                            // 0x3B0(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue;                       // 0x3C0(0x18)(None)
	class FText                                  K2Node_Select_Default_1;                           // 0x3D8(0x18)(None)
};
...
public:
	...
	class UFortStoreContext*                     CallFunc_GetContext_ReturnValue_1;                 // 0x10(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortStoreContext*                     CallFunc_GetContext_ReturnValue_2;                 // 0x48(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
