...
public:
	...
	uint8                                        Pad_B47[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_B5C[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	TArray<struct FNiagaraCompileEvent>          LastCompileEvents;                                 // 0x168(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FNiagaraCompileHash                   BaseScriptCompileHash;                             // 0x48(0x10)(NativeAccessSpecifierPublic)
	TArray<struct FNiagaraCompileHash>           ReferencedCompileHashes;                           // 0x58(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FGuid>                         ReferencedDependencyIds;                           // 0x68(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_B6A[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_B6C[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_B6D[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	bool                                         bIsStaticSwitch;                                   // 0xC0(0x1)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_B73[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_B74[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
