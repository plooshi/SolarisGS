...
public:
	...
	uint8                                        Pad_388[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3A3[0x15];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3BF[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_402[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_426[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_469[0x348];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_46E[0x14];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_470[0x68];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TScriptInterface<class IMovieScenePlaybackClient> PlaybackClient;                                    // 0x780(0x10)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                        Pad_471[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
