...
public:
	...
	class FText                                  Temp_text_Variable_10;                             // 0x138(0x18)(None)
	class FText                                  Temp_text_Variable_11;                             // 0x150(0x18)(None)
	...
	struct FSlateBrush                           Temp_struct_Variable_1;                            // 0x1F8(0x88)(None)
	struct FSlateBrush                           Temp_struct_Variable_2;                            // 0x280(0x88)(None)
	struct FSlateBrush                           Temp_struct_Variable_3;                            // 0x308(0x88)(None)
	...
	uint8                                        Pad_5074[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  K2Node_Select_Default_2;                           // 0x3C0(0x18)(None)
	...
	struct FSlateBrush                           CallFunc_MakeBrushFromTexture_ReturnValue_1;       // 0x470(0x88)(None)
	struct FSlateBrush                           K2Node_Select_Default_3;                           // 0x4F8(0x88)(None)
