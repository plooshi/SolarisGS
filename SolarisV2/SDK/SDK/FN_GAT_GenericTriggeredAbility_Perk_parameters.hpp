...
public:
	...
	uint8                                        Pad_626B[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	TScriptInterface<class IFortInventoryOwnerInterface> CallFunc_GiveItemToInventoryOwner_InventoryOwner_CastInput; // 0x78(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
