...
class UClass* AB_OctopusWeapon_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_OctopusWeapon_C");

	return Clss;
}


// B_OctopusWeapon_C B_OctopusWeapon.Default__B_OctopusWeapon_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_OctopusWeapon_C* AB_OctopusWeapon_C::GetDefaultObj()
{
	static class AB_OctopusWeapon_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_OctopusWeapon_C*>(AB_OctopusWeapon_C::StaticClass()->DefaultObject);
