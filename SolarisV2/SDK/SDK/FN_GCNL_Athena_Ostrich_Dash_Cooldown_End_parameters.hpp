...
struct AGCNL_Athena_Ostrich_Dash_Cooldown_End_C_OnRemoval_Params
{
public:
...
struct AGCNL_Athena_Ostrich_Dash_Cooldown_End_C_ExecuteUbergraph_GCNL_Athena_Ostrich_Dash_Cooldown_End_Params
{
public:
	...
	class USkeletalMeshComponent*                CallFunc_GetMechMesh_ReturnValue;                  // 0xF8(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_K2_AttachToComponent_ReturnValue_1;       // 0x111(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_61C1[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ATestMechVehicle_C*                    K2Node_DynamicCast_AsTest_Mech_Vehicle;            // 0x118(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
