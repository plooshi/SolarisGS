...
public:
	...
	uint8                                        Pad_3016[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<class USeasonPassLevelWidget*>        K2Node_MakeArray_Array;                            // 0x70(0x10)(ZeroConstructor, ReferenceParm)
