...
public:
	...
	double                                       CacheIntervalMins;                                 // 0x10(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FString, struct FEventsTimeline>  Channels;                                          // 0x18(0x50)(ZeroConstructor, NativeAccessSpecifierPublic)
};
