...
public:
	...
	uint8                                        Pad_648F[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<TScriptInterface<class IFortVehicleInterface>> RecentlyBouncedVehicles;                           // 0x288(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TScriptInterface<class IFortVehicleInterface> VehicleInterfaceToBounce;                          // 0x2B0(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
