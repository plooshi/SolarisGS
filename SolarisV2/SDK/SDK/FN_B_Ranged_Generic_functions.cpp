...
// Function B_Ranged_Generic.B_Ranged_Generic_C.GetActiveMuzzleComponent
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// class UFXSystemComponent*          NewParam                                                         (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AB_Ranged_Generic_C::GetActiveMuzzleComponent(class UFXSystemComponent** NewParam, class UObject* CallFunc_LoadAsset_Blocking_ReturnValue, class UNiagaraSystem* K2Node_DynamicCast_AsNiagara_System, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue, class FName CallFunc_GetMuzzleSocketName_ReturnValue, class UNiagaraComponent* CallFunc_SpawnSystemAttached_ReturnValue, bool CallFunc_IsValid_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("B_Ranged_Generic_C", "GetActiveMuzzleComponent");

	Params::AB_Ranged_Generic_C_GetActiveMuzzleComponent_Params Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UFXSystemComponent*          CallFunc_GetActiveMuzzleComponent_NewParam                       (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_Ranged_Generic_C::DeactivateMuzzleFX(class UFXSystemComponent* CallFunc_GetActiveMuzzleComponent_NewParam)
{
	static class UFunction* Func = nullptr;
	...
	Parms.CallFunc_GetActiveMuzzleComponent_NewParam = CallFunc_GetActiveMuzzleComponent_NewParam;
...
void AB_Ranged_Generic_C::Muzzle_Flash_FX(bool Persistent_Fire, bool CallFunc_IsUsingScope_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, float CallFunc_GetGameTimeInSeconds_ReturnValue, class UFXSystemComponent* CallFunc_GetActiveMuzzleComponent_NewParam)
{
	static class UFunction* Func = nullptr;
