...
public:
	...
	struct FFortAthenaLoadout                    CallFunc_GetLoadoutForPlayer_ReturnValue;          // 0x20(0xF0)(None)
	...
	struct FFortHomeBaseInfo                     CallFunc_GetHomeBaseInfoForPlayer_Result;          // 0x128(0x40)(None)
	bool                                         CallFunc_SetBannerImage_Success;                   // 0x168(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	uint8                                        Pad_2DAF[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
