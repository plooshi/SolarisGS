...
public:
	...
	bool                                         CallFunc_IsDBNO_ReturnValue;                       // 0x218(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TArray<class AFortPlayerController*>         K2Node_MakeArray_Array;                            // 0x230(0x10)(ZeroConstructor, ReferenceParm)
	...
	struct FGameplayTagContainer                 CallFunc_GetAthenaPlaylistContextTags_ReturnValue; // 0x2A0(0x20)(None)
	...
	uint8                                        Pad_3E86[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
