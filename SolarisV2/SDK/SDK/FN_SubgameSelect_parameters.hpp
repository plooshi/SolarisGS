...
public:
	...
	uint8                                        Pad_53EC[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class UWidget*                               K2Node_Event_Widget;                               // 0x20(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FContentPushState                     K2Node_Event_State;                                // 0x28(0x3)(NoDestructor)
	enum class EFortUIState                      K2Node_Event_PreviousUIState;                      // 0x2B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
