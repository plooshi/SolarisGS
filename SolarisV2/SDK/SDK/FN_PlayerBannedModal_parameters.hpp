...
public:
	...
	class FText                                  K2Node_Select_Default_1;                           // 0x340(0x18)(None)
	...
	class FText                                  K2Node_Select_Default_2;                           // 0x3F8(0x18)(None)
	class FText                                  CallFunc_Format_ReturnValue_1;                     // 0x410(0x18)(None)
	class FText                                  K2Node_Select_Default_3;                           // 0x428(0x18)(None)
	class FText                                  K2Node_Select_Default_4;                           // 0x440(0x18)(None)
};
...
public:
	...
	class FText                                  Temp_text_Variable_5;                              // 0x108(0x18)(None)
	...
	class FText                                  CallFunc_BanEnumToText_ReturnValue;                // 0x230(0x18)(None)
	...
	uint8                                        Pad_50DD[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_GetTimespanAsText_ReturnValue;            // 0x2E0(0x18)(None)
	class FText                                  K2Node_Select_Default_2;                           // 0x2F8(0x18)(None)
	...
	class FText                                  CallFunc_MakeLiteralText_ReturnValue;              // 0x378(0x18)(None)
	class FText                                  K2Node_Select_Default_3;                           // 0x390(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue_2;                     // 0x3F8(0x18)(None)
};
