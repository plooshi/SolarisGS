...
public:
	...
	class UParticleSystemComponent*              P_Cannon_Projectile_Spin;                          // 0x7A8(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class USoundBase*                            Cannonball_SurfaceImpactSound;                     // 0x7B0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class USoundBase*                            Cannonball_PlayerImpactSound;                      // 0x7B8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class USoundBase*                            Cannonball_ExplosionSound;                         // 0x7C0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               StartingVelocity;                                  // 0x7C8(0xC)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_49AD[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ABuildingActor*                        LastHitBuilding;                                   // 0x7D8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FScalableFloat                        EnemyLaunchVelocity;                               // 0x7E0(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        VelocityLossMultiplier;                            // 0x800(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        MinimumVelocity;                                   // 0x820(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        CannonballInitialSpeed;                            // 0x840(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        CannonballGravityScale;                            // 0x860(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
