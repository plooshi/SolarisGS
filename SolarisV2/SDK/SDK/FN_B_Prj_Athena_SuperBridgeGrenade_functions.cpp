...
class UClass* AB_Prj_Athena_SuperBridgeGrenade_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_Prj_Athena_SuperBridgeGrenade_C");

	return Clss;
}


// B_Prj_Athena_SuperBridgeGrenade_C B_Prj_Athena_SuperBridgeGrenade.Default__B_Prj_Athena_SuperBridgeGrenade_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_Prj_Athena_SuperBridgeGrenade_C* AB_Prj_Athena_SuperBridgeGrenade_C::GetDefaultObj()
{
	static class AB_Prj_Athena_SuperBridgeGrenade_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_Prj_Athena_SuperBridgeGrenade_C*>(AB_Prj_Athena_SuperBridgeGrenade_C::StaticClass()->DefaultObject);
