...
public:
	...
	uint8                                        Pad_4F76[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayTag                          BoostCue;                                          // 0xAC4(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                          BoostJumpPackCue;                                  // 0xACC(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_4F78[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UClass*                                JetpackInUseEffect;                                // 0xAD8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
