...
class UClass* UBluGloRequestHandler_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BluGloRequestHandler_C");

	return Clss;
}


// BluGloRequestHandler_C BluGloRequestHandler.Default__BluGloRequestHandler_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBluGloRequestHandler_C* UBluGloRequestHandler_C::GetDefaultObj()
{
	static class UBluGloRequestHandler_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBluGloRequestHandler_C*>(UBluGloRequestHandler_C::StaticClass()->DefaultObject);
