...
public:
	...
	UMulticastInlineDelegateProperty_            OnCancelButtonClicked;                             // 0x370(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
