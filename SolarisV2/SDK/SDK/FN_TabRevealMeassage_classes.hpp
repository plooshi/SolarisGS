...
public:
	...
	UMulticastInlineDelegateProperty_            TabMessageClosed;                                  // 0x3B8(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
