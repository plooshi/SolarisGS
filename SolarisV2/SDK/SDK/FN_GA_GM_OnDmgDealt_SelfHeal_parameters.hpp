...
public:
	...
	uint8                                        Pad_4621[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FGameplayEventData                    K2Node_Event_EventData;                            // 0x20(0xB0)(None)
	struct FGameplayEffectSpecHandle             CallFunc_MakeOutgoingGameplayEffectSpec_ReturnValue; // 0xD0(0x10)(None)
	...
	struct FGameplayEffectSpecHandle             CallFunc_AssignSetByCallerMagnitude_ReturnValue;   // 0xF0(0x10)(None)
