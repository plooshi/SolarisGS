...
public:
	...
	UMulticastInlineDelegateProperty_            HidePanelAnimFinished;                             // 0x318(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
