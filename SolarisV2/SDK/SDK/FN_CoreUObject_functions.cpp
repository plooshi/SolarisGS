...
namespace SDK
{
	...
	TUObjectArray* UObject::GObjects = reinterpret_cast<TUObjectArray*>(BaseAddress + Offsets::GObjects);
	...
	__declspec(noinline) class UFunction* UClass::GetFunction(const char *ClassName, const char *FuncName)
	{
