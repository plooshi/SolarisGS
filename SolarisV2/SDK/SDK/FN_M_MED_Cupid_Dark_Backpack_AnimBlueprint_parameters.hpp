...
// 0x10 (0x10 - 0x0)
// Function M_MED_Cupid_Dark_Backpack_AnimBlueprint.M_MED_Cupid_Dark_Backpack_AnimBlueprint_C.AnimGraph
struct UM_MED_Cupid_Dark_Backpack_AnimBlueprint_C_AnimGraph_Params
{
public:
...
struct UM_MED_Cupid_Dark_Backpack_AnimBlueprint_C_BlueprintUpdateAnimation_Params
{
public:
...
struct UM_MED_Cupid_Dark_Backpack_AnimBlueprint_C_ExecuteUbergraph_M_MED_Cupid_Dark_Backpack_AnimBlueprint_Params
{
public:
	...
	struct FVector                               CallFunc_GetAxes_X;                                // 0x2C(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_GetAxes_Y;                                // 0x38(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_GetAxes_Z;                                // 0x44(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_GetCurrentAcceleration_ReturnValue;       // 0x5C(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_Multiply_VectorVector_ReturnValue_1;      // 0x74(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
