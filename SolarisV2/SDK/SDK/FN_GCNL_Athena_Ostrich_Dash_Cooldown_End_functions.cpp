...
class UClass* AGCNL_Athena_Ostrich_Dash_Cooldown_End_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_Athena_Ostrich_Dash_Cooldown_End_C");

	return Clss;
}


// GCNL_Athena_Ostrich_Dash_Cooldown_End_C GCNL_Athena_Ostrich_Dash_Cooldown_End.Default__GCNL_Athena_Ostrich_Dash_Cooldown_End_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_Athena_Ostrich_Dash_Cooldown_End_C* AGCNL_Athena_Ostrich_Dash_Cooldown_End_C::GetDefaultObj()
{
	static class AGCNL_Athena_Ostrich_Dash_Cooldown_End_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_Athena_Ostrich_Dash_Cooldown_End_C*>(AGCNL_Athena_Ostrich_Dash_Cooldown_End_C::StaticClass()->DefaultObject);
