...
public:
	...
	struct FTransform                            Transform_Minus_HeroLoadOut;                       // 0x260(0x30)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	struct FTransform                            Transform_Minus_Command;                           // 0x290(0x30)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	class AHeroLoadoutItemPedestal_C*            HLMinusPedestal;                                   // 0x2C0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                CommandMinusPedestalMinusPlacement_ExecuteUbergraph_Frontend_HeroLoadout_RefProperty; // 0x2C8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                HeroLoadoutMinusPedestalMinusPlacement_ExecuteUbergraph_Frontend_HeroLoadout_RefProperty; // 0x2D0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
