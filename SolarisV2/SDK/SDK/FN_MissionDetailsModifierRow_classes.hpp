...
public:
	...
	TSoftObjectPtr<class UTexture2D>             SmallIcon;                                         // 0x2A8(0x28)(Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)
	bool                                         bUseSmallIcon;                                     // 0x2D0(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	uint8                                        Pad_307F[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TSoftObjectPtr<class UTexture2D>             LargeIcon;                                         // 0x2D8(0x28)(Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)
